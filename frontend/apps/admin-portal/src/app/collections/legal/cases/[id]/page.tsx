    ...
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex justify-between items-start">
        ...
        <div className="flex gap-3">
          <span className={`px-4 py-2 rounded-lg text-sm font-medium ${getStatusColor(legalCase.case_status)}`}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className="font-medium text-gray-900">{legalCase.customer_id}</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="font-medium text-gray-900">{legalCase.total_hearings}</p>
              </div>
              <div>
                <p className="text-sm text-gray-600">Filing Date</p>
                <p className="font-medium text-gray-900">{formatDate(legalCase.filing_date)}</p>
              </div>
              {legalCase.case_outcome && (
                <div>
                  <p className="text-sm text-gray-600">Case Outcome</p>
                  <p className="font-medium text-gray-900">{legalCase.case_outcome.replace('_', ' ').toUpperCase()}</p>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="col-span-2">
                ...
                <p className="font-medium text-gray-900">{legalCase.court_name || 'Not specified'}</p>
              </div>
          ...
          {/* Remove sections that use non-existent properties */}
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="space-y-2">
              ...
              {legalCase.case_status === 'judgement' && (
                <button
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <p className="text-sm font-medium text-gray-900">Total Hearings</p>
                  <p className="text-xs text-gray-600">{legalCase.total_hearings} hearings</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="space-y-3">
              ...
              {legalCase.total_legal_cost > 0 && (
                <div className="flex justify-between items-center pb-2 border-b">
                  <span className="text-sm text-gray-600">Legal Expenses</span>
                  <span className="font-semibold text-gray-900">{formatCurrency(legalCase.total_legal_cost)}</span>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                ...
                <span className={`px-2.5 py-0.5 rounded-full text-xs font-medium ${getStatusColor(legalCase.case_status)}`}>
                  {legalCase.case_status.replace('_', ' ').toUpperCase()}
                </span>
              </div>
              {legalCase.next_hearing_date && (
