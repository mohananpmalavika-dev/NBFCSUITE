...
from backend.shared.database.models import Base, TenantMixin, TimestampMixin
...
class Lead(Base, TenantMixin, TimestampMixin):
    ...
    # branch = relationship("Branch", foreign_keys=[assigned_to_branch_id])  # Disabled - requires ENABLE_BRANCH=true
...
class LeadAssignmentRule(Base, TenantMixin, TimestampMixin):
    ...
    # assign_to_branch = relationship("Branch", foreign_keys=[assign_to_branch_id])  # Disabled - requires ENABLE_BRANCH=true
